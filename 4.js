String.prototype.toJadenCase = function () {
    let rez=[]
    let h =  this.toString().split(' ');
    h.map(i =>rez.push(`${i[0].toUpperCase()}${i.slice(1)}`))
    return rez.join(' ')
};


var str1 = "How can mirrors be real if our eyes aren't real";
console.log(str1.toJadenCase())     // "How Can Mors Be Real If Our Eyes Aren't Realirr");
