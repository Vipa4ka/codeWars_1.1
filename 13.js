var validWord = function (dictionary, word) {
    ...
    for (let i = 0; i < dictionary.length-1; i++){
        let r = dictionary[i] + dictionary[i + 1];        
        if (word.includes(r)) {
           y+=1
        }
        let g = dictionary.join('')
...
// console.log(  validWord(['jwdz', 'f','bfcn','cg','sh','h','wyp','j','scw','py','syn','shy','pylw','shy',],'jwdzfbfcncgshhwypjscw',),); // true
